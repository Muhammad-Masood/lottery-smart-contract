...
contract HelperConfig is Script {
    ...
    function setSepliaHelperConfig() internal {
        s_networkConfig = NetworkConfig(0x8103B0A8A00be2DDC778e6e7eaa21791Cd364625,
        0x474e34a077df58807dbe9c96d3c009b23b3c6d0cce433e59bbf5b34f823bc56c,
        0x779877A7B0D9E8603169DdbD7836e478b4624789);
    }

    function setEthereumHelperConfig() internal {
        s_networkConfig = NetworkConfig(0x271682DEB8C4E0901D1a1550aD2e64D568E69909,
    ...
    function setAnvilHelperConfig() internal {
        ...
        s_networkConfig = NetworkConfig(address(vrfCoordinator),0x8af398995b04c28e9951adb9721ef74c74f93e6a478f39e7e0777be13527e7ef,address(0));   
    }

    function getNetworkConfig() public view returns(address,bytes32){
        return (s_networkConfig.vrfCoordinator,s_networkConfig.keyHash);
    }
